...
# hadoop
RUN cd /usr/local && wget http://192.168.6.155/hadoop/common/hadoop-2.7.1/hadoop-2.7.1.tar.gz && \
    tar -xvf hadoop-2.7.1.tar.gz && mv hadoop-2.7.1 hadoop && rm hadoop-2.7.1.tar.gz

RUN cd /usr/local/hadoop/lib/native && rm -rf ./*  &&\
