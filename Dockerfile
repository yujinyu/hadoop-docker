...
#RUN wget http://192.168.6.193/java/8.0.5.26/linux/x86_64/ibm-java-x86_64-sdk-8.0-5.26.bin && \
...
RUN tar -xvf hadoop-2.8.5.tar.gz && mv hadoop-2.8.5 /usr/local/hadoop && rm -rf hadoop-2.8.5.tar.gz
