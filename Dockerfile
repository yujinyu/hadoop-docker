# Creates pseudo distributed hadoop 2.4.0
...
# hadoop
RUN wget https://archive.apache.org/dist/hadoop/common/hadoop-2.4.0/hadoop-2.4.0.tar.gz
...
RUN curl -Ls http://dl.bintray.com/sequenceiq/sequenceiq-bin/hadoop-native-64-2.4.0.tar|tar -x -C /usr/local/hadoop/lib/native/
